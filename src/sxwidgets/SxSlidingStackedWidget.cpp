/// \file SxSlidingStackedWidget.cpp
...
#include "SxSlidingStackedWidget.h"

SxSlidingStackedWidget::SxSlidingStackedWidget(QWidget *parent)
...
SxSlidingStackedWidget::~SxSlidingStackedWidget(){
}

void SxSlidingStackedWidget::setVerticalMode(bool vertical) {
        m_vertical=vertical;
}

void SxSlidingStackedWidget::setSpeed(int speed) {
        m_speed = speed;
}

void SxSlidingStackedWidget::setAnimation(enum QEasingCurve::Type animationtype) {
        m_animationtype = animationtype;
}

void SxSlidingStackedWidget::setWrap(bool wrap) {
        m_wrap=wrap;
}

void SxSlidingStackedWidget::slideInNext() {
...
void SxSlidingStackedWidget::slideInPrev() {
        int now=currentIndex();
        if (m_wrap||(now>0))
                slideInIdx(now-1);
}

void SxSlidingStackedWidget::slideInIdx(int idx, enum t_direction direction) {
...
void SxSlidingStackedWidget::slideInWgt(QWidget * newwidget, enum t_direction  direction) {
...
void SxSlidingStackedWidget::animationDoneSlot(void) {
